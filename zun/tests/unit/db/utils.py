...
def get_test_container(**kwargs):
    return {
        ...
        'logs_url': kwargs.get('logs_url', None),
        'logs_token': kwargs.get('logs_token', None),
        ...
        'dns_options': kwargs.get('dns_options', None),
        'extra_hosts': kwargs.get('extra_hosts', None),
        'ulimits': kwargs.get('ulimits', None),
        'shm_size': kwargs.get('shm_size', None),
        'read_only': kwargs.get('read_only', None),
        'init': kwargs.get('init', None),
        'group_add': kwargs.get('group_add', None),
        'oom_score_adj': kwargs.get('oom_score_adj', None),
        'tmpfs': kwargs.get('tmpfs', None),
